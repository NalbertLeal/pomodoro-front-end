...
class PomodoroRepository {
  ...
  resetTimer() {
    ...
    PomodoroRepository._uiCallback(0, currentStateStr)
  }
  ...
  _pomodoro() {
    ...
    if (currentStateStr === 'work' && PomodoroRepository.remainTime === 0) {
      ...
      this.pauseTimer()
      this.startTimer()
    }  else if (PomodoroRepository.pomodoroStage === 6 && PomodoroRepository.remainTime === 0) {
    ...
    PomodoroRepository._uiCallback(PomodoroRepository.remainTime, currentStateStr)
  }
}
